...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item {{ request()->routeIs('mahasiswa.dokumen.create') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('mahasiswa.dokumen.create') }}">
                    <i class="fas fa-fw fa-plus-circle"></i>
                    <span>Ajukan Cek Baru</span>
                </a>
            </li>
            <li class="nav-item {{ request()->routeIs('mahasiswa.dokumen.index') || request()->routeIs('mahasiswa.dokumen.show') || request()->routeIs('mahasiswa.dokumen.edit') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('mahasiswa.dokumen.index') }}">
                    <i class="fas fa-fw fa-history"></i>
                    <span>Riwayat & Hasil</span></a>
            </li>
