...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('operator.dokumen.riwayat') }}">
                    <i class="fas fa-fw fa-file-invoice"></i>
                    <span>Riwayat Dokumen</span></a>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                @if($pendingCount > 0)
                                <a class="dropdown-item d-flex align-items-center" href="{{ route('operator.dokumen.index') }}">
                                    <div class="mr-3">
                                    ...
                                    <div>
                                        <div class="small text-gray-500">Antrean Dokumen Baru</div>
                                        <span class="font-weight-bold">Ada {{ $pendingCount }} pengajuan dokumen baru yang menunggu untuk dikerjakan!</span>
                                    </div>
                                </a>
                                @else
                                <a class="dropdown-item text-center small text-gray-500" href="#">Tidak ada pemberitahuan baru</a>
                                @endif
                                <a class="dropdown-item text-center small text-gray-500" href="{{ route('operator.dokumen.index') }}">Ke Antrean
                                    Pengajuan</a>
                            </div>
                        </li>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Poltekkes Kemenkes Bengkulu 2026</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <x-dropdown-link :href="route('logout')" class="btn btn-primary" style="text-color: white;"
