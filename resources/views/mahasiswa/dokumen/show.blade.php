        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <p>
                        <a href="{{ Storage::url($dokumen->file_asli) }}" target="_blank" class="btn btn-sm btn-info">
                ...
                <div class="col-md-6">
                    ...
                    <p>
                        <a href="{{ Storage::url($dokumen->bukti_bayar) }}" target="_blank" class="btn btn-sm btn-info">
            ...
            <div class="mt-4">
                ...
                <div class="alert alert-info">
                    ...
                    <p><strong>Tanggal Cek:</strong>
                        {{ $dokumen->hasilTurnitin->created_at->format('d-m-Y H:i:s') }}
                    </p>
            ...
            <div class="mt-4 d-flex gap-2">
                ...
                <form action="{{ route('mahasiswa.dokumen.destroy', $dokumen->id) }}" method="POST"
